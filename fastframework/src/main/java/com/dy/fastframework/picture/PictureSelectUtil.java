...
public class PictureSelectUtil {
    public static void chooseNinePic(Activity activity,int clums,OnImagePickCompleteListener onImagePickCompleteListener){
        ImagePicker.withMulti(new WeiChartPresenter(activity.getClass(),true))//指定presenter
                //设置选择的最大数
                .setMaxCount(9)
                //设置列数
...
//                .filterMimeTypes(MimeType.GIF)
    ...
    public static void chooseMuiltPic(Activity activity,int count,int clums,OnImagePickCompleteListener onImagePickCompleteListener){
        ImagePicker.withMulti(new WeiChartPresenter(activity.getClass(),true))//指定presenter
                //设置选择的最大数
                .setMaxCount(count)
                //设置列数
