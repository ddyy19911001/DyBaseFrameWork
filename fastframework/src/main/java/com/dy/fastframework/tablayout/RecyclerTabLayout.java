 ...
 */
package com.dy.fastframework.tablayout;
...
public class RecyclerTabLayout extends RecyclerView {
    ...
    public boolean isDivideWidth(){
        return isDivideWidth;
    }
    ...
    public static class DefaultAdapter
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            LinearLayout.LayoutParams tabLayoutParams = createLayoutParamsForTabs();
            tabLayoutParams.weight=1;
            tabTextView.setLayoutParams(tabLayoutParams);
            return new ViewHolder(tabTextView,onTabTwoClickListener);
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void onDoubleClick(){
                ...
                if (pos == getCurrentIndicatorPosition()) {
                    if (onTabTwoClickListener != null) {
                        onTabTwoClickListener.onTabTowClicked(pos);
                        LogUtils.v("双击");
                    }
                }
            }
    ...
    public interface OnTabTwoClickListener{
         void onTabTowClicked(int position);
    }
