...
public class BaseToastUtil {
    ...
    public BaseToastUtil(Context context, String msg) {
        message = msg;
        ...
        if (mToast == null) {
            ...
            Log.i("BaseToastUtil", "Toast create...");
        }
        //设置toast居中显示
    ...
    public void show() {
        mToast.show();
        Log.i("BaseToastUtil", "Toast show...");
    }
    ...
    private void hide() {
        ...
        canceled = true;
        Log.i("BaseToastUtil", "Toast that customed duration hide...");
    }
    ...
    private void showUntilCancel() {
        ...
        mHandler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Log.i("BaseToastUtil", "Toast showUntilCancel...");
                showUntilCancel();
            }
        }, Toast.LENGTH_LONG);
    }
