...
public interface ApiService {
    ...
    @HEAD()
    Observable<ResponseBody> head(@Url String url, @QueryMap Map<String, Object> maps);

    @OPTIONS()
    Observable<ResponseBody> options(@Url String url, @QueryMap Map<String, Object> maps);
    ...
    @FormUrlEncoded
    @PATCH()
    Observable<ResponseBody> patch(@Url() String url, @FieldMap Map<String, Object> maps);
